...
#
#    $Id: query.pl,v 1.22 2004/11/04 15:16:58 peder Exp $
#
# Copyright (C) 2001, 2002, 2004 by Peder Stray <peder@ninja.no>
#
...
[
 'query_created',
 '{line_start}{hilight Query:} .%R:%nstarted with%R:%n. %W{nick $0} %nin window %r$2',
